...
import com.example.notifications.pool.PollingService;
import com.example.notifications.pool.PollingUtils;
...
public class MainActivity extends BaseActivity implements OnClickListener
{
    ...
    private Button btn_show_intent_send_message;
     ...
     */
    int notifyId = 100;
    private Button btn_start_notice;
    private Button btn_stop_notice;
    ...
    private void initView()
    {
        ...
        btn_show_intent_send_message = (Button) findViewById(R.id.btn_show_intent_send_message);
        ...
        btn_start_notice = (Button) findViewById(R.id.btn_start_notice);
        btn_stop_notice = (Button) findViewById(R.id.btn_stop_notice);
        ...
        btn_show_intent_send_message.setOnClickListener(this);
        ...
        btn_start_notice.setOnClickListener(this);
        btn_stop_notice.setOnClickListener(this);
    }
...
//		notification.flags = Notification.FLAG_AUTO_CANCEL; //在通知栏上点击此通知后自动清除此通知
     ...
     * 点击通知，跳转，传递数据
     */
    private void showIntentSentMesageNotify()
    {
        mBuilder.setAutoCancel(true)//点击后让通知将消失
                .setContentTitle("测试标题")
                .setContentText("点击跳转")
                .setTicker("传递的数据是：1+2=3");
        //点击的意图ACTION是跳转到Intent
        Intent resultIntent = new Intent(this, TestActivity.class);
        Bundle bundle = new Bundle();
        bundle.putString("test", "1+2=3");
        resultIntent.putExtra("test", bundle);
    ...
    public void onClick(View v)
    {
        switch (v.getId())
        {
            ...
            case R.id.btn_show_intent_act:
                ...
                break;
            case R.id.btn_show_intent_send_message:
                showIntentSentMesageNotify();
                break;
            ...
            case R.id.btn_show_custom:
                ...
                break;
            case R.id.btn_start_notice:
                startNotice();
                break;
            case R.id.btn_stop_notice:
                stopNotice();
                break;
